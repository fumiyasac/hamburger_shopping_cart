...
class BurgerRepository {
  ...
  final List<Burger> _mockBurgers = [
    ...
    Burger(
      ...
      ingredients: ['ビーフパティ', 'ハラペーニョ', 'スパイシーソース', 'レタス', 'チーズ'],
      calories: 610,
    ...
    Burger(
      ...
      price: 980,
      imageUrl: 'https://images.unsplash.com/photo-1571091655789-405eb7a3a3a8?auto=format&fit=crop&w=800&q=80',
      ingredients: ['ダブルパティ', 'チーズ', 'レタス', 'トマト', 'オニオン', 'ピクルス'],
      calories: 890,
    ...
    Burger(
      ...
      ingredients: ['白身魚フライ', 'タルタルソース', 'レタス', 'チーズ', 'レモン'],
      calories: 480,
    ...
    Burger(
      ...
      ingredients: ['チキンパティ', 'レタス', 'トマト', 'マヨネーズ', 'オニオン'],
      calories: 550,
    ...
    Burger(
      ...
      ingredients: ['野菜パティ', 'レタス', 'トマト', 'アボカド', 'オニオン', 'キュウリ'],
      calories: 420,
